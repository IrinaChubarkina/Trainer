<template>
    <div class="sections-list">
        <div class="section-card" v-for="section in getFav">
            <div class="section-card__content">
                ...
                <div class="section-card__content__fav"
                     ...
                     v-bind:class="{ 'section-card__content__fav--active': section.is_fav }">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            getFav() {
                return this.$store.state.favouriteSectionList;
            }
        },
        mounted() {
            this.$store.dispatch('getFavouriteSections');
        }
    }
</script>